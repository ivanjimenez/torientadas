 ...
 * <ul>
 *   <li>{@link umlMM.impl.AttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link umlMM.impl.AttributeImpl#getType <em>Type</em>}</li>
 *   <li>{@link umlMM.impl.AttributeImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeImpl extends EObjectImpl implements Attribute {
	 ...
	 * @generated
	 */
	public umlMM.Class getOwner() {
		if (owner != null && owner.eIsProxy()) {
			InternalEObject oldOwner = (InternalEObject)owner;
			owner = (umlMM.Class)eResolveProxy(oldOwner);
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlMMPackage.ATTRIBUTE__OWNER, oldOwner, owner));
			}
		}
		return owner;
	}
	 ...
	 * @generated
	 */
	public umlMM.Class basicGetOwner() {
		return owner;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwner(umlMM.Class newOwner, NotificationChain msgs) {
		umlMM.Class oldOwner = owner;
		owner = newOwner;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmlMMPackage.ATTRIBUTE__OWNER, oldOwner, newOwner);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setOwner(umlMM.Class newOwner) {
		if (newOwner != owner) {
			NotificationChain msgs = null;
			if (owner != null)
				msgs = ((InternalEObject)owner).eInverseRemove(this, UmlMMPackage.CLASS__ATTRIBUTE, umlMM.Class.class, msgs);
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, UmlMMPackage.CLASS__ATTRIBUTE, umlMM.Class.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UmlMMPackage.ATTRIBUTE__OWNER:
				if (owner != null)
					msgs = ((InternalEObject)owner).eInverseRemove(this, UmlMMPackage.CLASS__ATTRIBUTE, umlMM.Class.class, msgs);
				return basicSetOwner((umlMM.Class)otherEnd, msgs);
		}
