...
public class UmlMMPackageImpl extends EPackageImpl implements UmlMMPackage {
	 ...
	 * @generated
	 */
	public EReference getAssociaton_Destintation() {
	...
	public EAttribute getAssociaton_Name() {
		return (EAttribute)associatonEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getAssociaton_Source() {
		return (EReference)associatonEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getClass_DestintationOf() {
	...
	public void createPackageContents() {
		...
		createEReference(associatonEClass, ASSOCIATON__DESTINTATION);

		classEClass = createEClass(CLASS);
		createEReference(classEClass, CLASS__SOURCE_OF);
		createEReference(classEClass, CLASS__ATTRIBUTE);
		createEReference(classEClass, CLASS__DESTINTATION_OF);
	...
	public void initializePackageContents() {
		...
		initEReference(getAssociaton_Destintation(), this.getClass_(), this.getClass_DestintationOf(), "destintation", null, 1, 1, Associaton.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getClass_DestintationOf(), this.getAssociaton(), this.getAssociaton_Destintation(), "destintationOf", null, 0, -1, umlMM.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getClassifier_Namespace(), this.getPackage(), null, "namespace", null, 1, 1, Classifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
