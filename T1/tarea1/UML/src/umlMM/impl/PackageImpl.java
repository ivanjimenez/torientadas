 ...
 * @generated
 */
public class PackageImpl extends EObjectImpl implements umlMM.Package {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Associaton> association;
	 ...
	 * @generated
	 */
	public EList<Associaton> getAssociation() {
		if (association == null) {
			association = new EObjectWithInverseResolvingEList<Associaton>(Associaton.class, this, UmlMMPackage.PACKAGE__ASSOCIATION, UmlMMPackage.ASSOCIATON__NAMESPACE);
		}
		return association;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UmlMMPackage.PACKAGE__ASSOCIATION:
				...
				getAssociation().addAll((Collection<? extends Associaton>)newValue);
				return;
		}
