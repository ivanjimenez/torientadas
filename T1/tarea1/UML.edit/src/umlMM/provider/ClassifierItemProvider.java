...
/**
 * This is the item provider adapter for a {@link umlMM.Classifier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UmlMMPackage.Literals.CLASSIFIER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addNamespacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Classifier_namespace_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Classifier_namespace_feature", "_UI_Classifier_type"),
				 UmlMMPackage.Literals.CLASSIFIER__NAMESPACE,
				 true,
				 false,
				 true,
				 null,
