...
public class UMLNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = umlMM.diagram.part.UMLDiagramEditorPlugin
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		umlMM.diagram.navigator.UMLAbstractNavigatorItem abstractNavigatorItem = (umlMM.diagram.navigator.UMLAbstractNavigatorItem) aSelection
				.getFirstElement();
		View navigatorView = null;
		if (abstractNavigatorItem instanceof umlMM.diagram.navigator.UMLNavigatorItem) {
			navigatorView = ((umlMM.diagram.navigator.UMLNavigatorItem) abstractNavigatorItem)
					.getView();
			...
			if (navigatorGroup.getParent() instanceof umlMM.diagram.navigator.UMLNavigatorItem) {
				navigatorView = ((umlMM.diagram.navigator.UMLNavigatorItem) navigatorGroup
						.getParent()).getView();
			}
		}
